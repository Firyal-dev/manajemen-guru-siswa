    ...
    <aside id="sidebar"
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            <a href="{{ route('dashboard') }}"
                class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-150 text-on-surface-variant hover:text-primary hover:bg-surface-container-high {{ request()->routeIs('dashboard') ? 'nav-active' : '' }}">
                <span class="material-symbols-outlined text-[22px]">dashboard</span>
                <span class="text-[14px] font-semibold">Dashboard</span>
            </a>
            <a href="{{ route('tahun-ajaran.index') }}"
                class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-150 text-on-surface-variant hover:text-primary hover:bg-surface-container-high {{ request()->routeIs('tahun-ajaran.*') ? 'nav-active' : '' }}">
            ...
            <a href="{{ route('guru') }}"
                class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-150 text-on-surface-variant hover:text-primary hover:bg-surface-container-high {{ request()->routeIs('guru') ? 'nav-active' : '' }}">
                <span class="material-symbols-outlined text-[22px]">manage_accounts</span>
                <span class="text-[14px] font-semibold">Data Guru</span>
            </a>
            <a href="{{ route('siswa') }}"
                class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-150 text-on-surface-variant hover:text-primary hover:bg-surface-container-high {{ request()->routeIs('siswa') ? 'nav-active' : '' }}">
                <span class="material-symbols-outlined text-[22px]">groups</span>
                <span class="text-[14px] font-semibold">Data Siswa</span>
            </a>
            <a href="{{ route('mapel.index') }}"
                class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-150 text-on-surface-variant hover:text-primary hover:bg-surface-container-high {{ request()->routeIs('mapel.*') ? 'nav-active' : '' }}">
            ...
            <a href="{{ route('kelas') }}"
                class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-150 text-on-surface-variant hover:text-primary hover:bg-surface-container-high {{ request()->routeIs('kelas') ? 'nav-active' : '' }}">
            ...
            <a href="{{ route('jurusan.index') }}"
                class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-150 text-on-surface-variant hover:text-primary hover:bg-surface-container-high {{ request()->routeIs('jurusan.*') ? 'nav-active' : '' }}">
            ...
            <a href="{{ route('penugasan.wali-kelas') }}"
                class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-150 text-on-surface-variant hover:text-primary hover:bg-surface-container-high {{ request()->routeIs('penugasan.wali-kelas') ? 'nav-active' : '' }}">
            ...
            <a href="{{ route('penugasan.guru-mapel') }}"
                class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-150 text-on-surface-variant hover:text-primary hover:bg-surface-container-high {{ request()->routeIs('penugasan.guru-mapel') ? 'nav-active' : '' }}">
        ...
        <div class="p-4 border-t border-outline-variant">
            <div class="flex items-center gap-3">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit"
                        class="p-1.5 text-on-surface-variant hover:text-error-crimson hover:bg-error-container/20 rounded-lg transition-colors"
                        title="Logout">
    ...
    <header
        ...
        <div class="flex items-center gap-3">
            <button onclick="toggleSidebar()"
                class="md:hidden p-2 text-on-surface-variant hover:bg-surface-container-low rounded-lg transition-colors">
