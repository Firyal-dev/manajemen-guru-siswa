                                ...
                                <tr @click="selected = {{ json_encode($siswaData) }}"
                                    ...
                                    <td class="py-3 px-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            @if($siswa->url_foto)
                                                <img src="{{ asset('storage/' . $siswa->url_foto) }}" alt="Foto siswa" class="w-full h-full object-cover">
                                            @else
                                                <div class="w-full h-full bg-green-100 text-secondary flex items-center justify-center font-bold text-[13px]">
